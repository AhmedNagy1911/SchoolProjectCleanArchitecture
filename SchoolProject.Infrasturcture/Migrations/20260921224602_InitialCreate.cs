        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AcademicYears_Dates", "[EndDate] > [StartDate]");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FeeTypes_Amount", "[Amount] > 0");
                    table.ForeignKey(
                        name: "FK_FeeTypes_AcademicYears_AcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDegree = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    Type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exams", x => x.Id);
                    table.CheckConstraint("CK_Exams_MaxDegree", "[MaxDegree] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherSubjects_Subjects_SubID",
                        column: x => x.SubID,
                        principalTable: "Subjects",
                        principalColumn: "SubID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TimetableSlots_Time", "[EndTime] > [StartTime]");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimetableSlots_Subjects_SubID",
                        column: x => x.SubID,
                        principalTable: "Subjects",
                        principalColumn: "SubID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordedByTeacherId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Attendances_Teachers_RecordedByTeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassEnrollments_AcademicYears_AcademicYearId",
                        column: x => x.AcademicYearId,
                        principalTable: "AcademicYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassEnrollments_Students_StudID",
                        column: x => x.StudID,
                        principalTable: "Students",
                        principalColumn: "StudID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoices_Students_StudID",
                        column: x => x.StudID,
                        principalTable: "Students",
                        principalColumn: "StudID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParentStudents_Students_StudID",
                        column: x => x.StudID,
                        principalTable: "Students",
                        principalColumn: "StudID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_StudentGrades_Degree", "[Degree] >= 0");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentGrades_Students_StudID",
                        column: x => x.StudID,
                        principalTable: "Students",
                        principalColumn: "StudID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "0191a4b6-c4fc-752e-9d95-40b7a5cb88f0", "0191a4b6-c4fc-752e-9d95-40b85cf3fd22", "Teacher", "TEACHER" },
                    { "4315061C-AF52-4C13-A9EF-ED41A5941362", "4F9BD8C2-CD96-4CB5-BBD4-3249D2A6AB9C", "Parent", "PARENT" },
                    { "54201DC0-4E33-45A3-819E-2CD103888BE0", "1279C76D-2C22-4D57-B453-91D5C5B2F8E0", "Student", "STUDENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ClassRoomId_Date",
                table: "Attendances",
                columns: new[] { "ClassRoomId", "Date" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudID_ClassRoomId_Date",
                table: "Attendances",
                columns: new[] { "StudID", "ClassRoomId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassEnrollments_AcademicYearId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassEnrollments_StudID_AcademicYearId",
                table: "ClassEnrollments",
                columns: new[] { "StudID", "AcademicYearId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassRooms_AcademicYearId_DID_Name",
                table: "ClassRooms",
                columns: new[] { "AcademicYearId", "DID", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmetSubjects_DID_SubID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_ClassRoomId_SubID",
                table: "Exams",
                columns: new[] { "ClassRoomId", "SubID" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeeTypes_AcademicYearId_Name",
                table: "FeeTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_StudID_AcademicYearId",
                table: "Invoices",
                columns: new[] { "StudID", "AcademicYearId" });

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_StudID_FeeTypeId",
                table: "Invoices",
                columns: new[] { "StudID", "FeeTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParentStudents_ParentId_StudID",
                table: "ParentStudents",
                columns: new[] { "ParentId", "StudID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParentStudents_StudID",
                table: "ParentStudents",
                column: "StudID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGrades_ExamId_StudID",
                table: "StudentGrades",
                columns: new[] { "ExamId", "StudID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentGrades_StudID",
                table: "StudentGrades",
                column: "StudID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjects_StudID_SubID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjects_SubID",
                table: "TeacherSubjects",
                column: "SubID");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjects_TeacherId_SubID_ClassRoomId",
                table: "TeacherSubjects",
                columns: new[] { "TeacherId", "SubID", "ClassRoomId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimetableSlots_ClassRoomId_DayOfWeek_StartTime",
                table: "TimetableSlots",
                columns: new[] { "ClassRoomId", "DayOfWeek", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimetableSlots_SubID",
                table: "TimetableSlots",
                column: "SubID");
